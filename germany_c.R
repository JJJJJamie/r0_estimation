...
deaths<- Predictive_death$Germany
deaths <- deaths[57:length(deaths)] # only keeping daily new deaths > 10 # 19th March
t_deaths <- length(deaths)
t_before_fd <- 30 # 18th feb
t_total <- t_deaths + t_before_fd

bond_n <- 3 # smooth out the death data for better estimation
